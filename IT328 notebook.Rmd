...
This histogram show us that the majority of the students in the dataset are performing well since it seems like the grades are spanning between 75 and 98. This analysis will help us determine whether the academic performance level of students is a contributing factor to their college attendance or not.
...
We normalized the attribute parent_salary and house_area to take values between 0 and 1 that will facilities and helps a lot in handling the data to extracting more reliable conclusions
